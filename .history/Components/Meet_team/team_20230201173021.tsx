                ...
                <div className={`${styles.Grid}`}>
                    <div style={{ transform: side ? "rotateY(180deg)" : "" }} className={`${styles.holder} ${"flex flex-col items-center  text-center "}`}>
                        <div className={styles.back}>
                            ...
                            <h1 className={styles.Back_info}>
                                Targetologist, SMM specialist, marketer
                                The presence of a pedagogical
                                economic and
                                legal education,
                                experience in sales, business and
                                knowledge of business processes
                                over 14 years allows
                                achieve excellent
                                results in any niche
                                Profile audit and promotion consultations
                                </br>
                                Marketing strategy for promotion (brand / product,
                                services)
                                Analysis of target audience, competitors
                                Development of a promotion strategy;
                                Development of a content plan for stories and posts
                                Installation of materials (video, photo, etc.)
                                Strategy for increasing engagement (activity/
                                contests)
                                Analysis of the effectiveness of SMM promotion;
                                Monitor brand/account mentions on social media
                                networks
                                Recommendations for promotion free and paid
                                methods
                            </h1>
